...
RSpec.describe Year2022::Day04 do
  ...
  describe "part 1" do
    it "returns the number of fully contained ranges for the example input" do
      expect(described_class.part_1(example_input)).to eq(2)
    end

    it "returns the correct answer for my input" do
      expect(described_class.part_1(input)).to eq(462)
    end
  end

  describe "part 2" do
    it "returns the number of overlaps for the example input" do
      expect(described_class.part_2(example_input)).to eq(4)
    end

    it "returns nil for my input" do
      expect(described_class.part_2(input)).to eq(835)
    end
  end
end
